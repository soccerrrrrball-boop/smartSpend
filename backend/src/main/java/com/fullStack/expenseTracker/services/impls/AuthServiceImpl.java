...
public class AuthServiceImpl implements AuthService {
    ...
    @Value("${app.verification-code-expiration-ms}")
    ...
    public ResponseEntity<ApiResponseDto<?>> save(SignUpRequestDto signUpRequestDto)
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.CREATED).body(new ApiResponseDto<>(
                    ApiResponseStatus.SUCCESS, HttpStatus.CREATED,"User account has been successfully created!"
            ));
    ...
    public ResponseEntity<ApiResponseDto<?>> resendVerificationCode(String email) throws UserNotFoundException, UserServiceLogicException {
        // Email verification is disabled - users are enabled immediately upon registration
        ...
        return ResponseEntity.status(HttpStatus.OK).body(new ApiResponseDto<>(
                ApiResponseStatus.SUCCESS, HttpStatus.OK, "Email verification is not required. Your account is already active.")
        );
    }
